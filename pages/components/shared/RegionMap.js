...
import WorldMap from '../../../public/assets/maps/world-countries-sans-antarctica.json'
					...
					geographies.map(geo => {
						...
						return (
							<Geography
								...
								strokeWidth={2}
								fill={getHighlightedRegion(geoName, data, mode === MODE_DARK ? `theme.gray.500` : `theme.gray.100`)}
								stroke={mode === MODE_DARK ? `theme.gray.600` : `theme.gray.300`}
								style={{
									hover: {
										fill: getRegionHoverColor(geoName, data, mode === MODE_DARK ? `theme.gray.500` : `theme.gray.100`),
										outline: "none"
									}
								}}
							/>
